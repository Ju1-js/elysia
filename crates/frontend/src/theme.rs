/// Centralized theme constants for the Elysia frontend.
///
...
/// Secondary accent color used for some progress bars and highlights
/// This blue shade is used in component download widgets and some UI elements
pub const ACCENT_SECONDARY: &str = "rgb(50, 110, 170)";
